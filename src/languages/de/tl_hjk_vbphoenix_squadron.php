...
$GLOBALS['TL_LANG']['tl_hjk_vbphoenix_squadron'] = array (
    // operations
    'edit'          => array('bearbeiten', 'bearbeiten'),
    'delete'        => array ('löschen', 'löschen'),
    'upload'        => array ('CSV upload', 'neue CSV-Datei hochladen und Tabelle überschreiben'),
    'new'           => array ('Neu', 'neue Staffel anlegen'),
    ...
    'year'          => array ('Jahr','Anfangsjahr der Saison für diese Staffel'),
    // legends 
    'name_legend' => 'Name und ID',
    
    // fields
    'name' => array ('Name', '(Anzeige-)Name der Staffel'),
    'phoenix_id' => array ('ID', 'Id der Staffel auf dem Phoenix-Server,')
);
