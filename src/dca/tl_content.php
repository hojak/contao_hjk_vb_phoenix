...
$GLOBALS['TL_DCA']['tl_content']['palettes']['hjk_vbphoenix_schedule']  =
    '{type_legend},type,headline;{hjk_vbphoenix_schedule_legend},hjk_vbphoenix_squadron,hjk_vbphoenix_season,hjk_vbphoenix_games,hjk_vbphoenix_team;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
...
$GLOBALS['TL_DCA']['tl_content']['fields']['hjk_vbphoenix_games'] = array (
    ...
    'inputType'               => 'select',
    'options'                 => array (
        'all'       => &$GLOBALS['TL_LANG']['tl_content']['hjk_vbphoenix_games_all'],
        'team'      => &$GLOBALS['TL_LANG']['tl_content']['hjk_vbphoenix_games_team'],
        'team_home' => &$GLOBALS['TL_LANG']['tl_content']['hjk_vbphoenix_games_team_home'],
        'team_away' => &$GLOBALS['TL_LANG']['tl_content']['hjk_vbphoenix_games_team_away'],
    ), 
    'default'                 => 'all',
